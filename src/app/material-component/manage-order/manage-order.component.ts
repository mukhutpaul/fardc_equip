...
export class ManageOrderComponent implements OnInit {
 ...
 manageOrderForm:any = FormGroup;
  ...
  getCategorys(){
    this.categoyService.getCategory().subscribe((response:any)=>{
  ...
  getProductsByCategory(value:any){
    this.productService.getProductByCategory(value).subscribe((response:any)=>{
  ...
  getProductDetails(values:any){
    this.productService.getProductById(values.id).subscribe((response:any)=>{
